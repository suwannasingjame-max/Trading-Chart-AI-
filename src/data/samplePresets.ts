...
export const SAMPLE_PRESETS: SamplePreset[] = [
  {
    id: 'gold_smc_buy',
    name: 'XAUUSD (ทองคำ) - SMC Bullish Order Block Setup',
    symbol: 'XAU/USD',
    strategy: 'SMC',
  ...
  {
    id: 'eurusd_smc_sell',
    name: 'EURUSD - SMC Bearish OB & FVG Sell Setup',
    symbol: 'EUR/USD',
    strategy: 'SMC',
    description: 'ตัวอย่าง EURUSD เกิดโครงสร้าง Bearish ChoCH บน H4, H1 Sweep Buy-side Liquidity และ M15 เข้าเทรดในโซน Bearish Order Block',
    h4DataUrl: generateCandlestickChartSvg('Macro Bearish Structure & ChoCH', 'H4', 'EURUSD', 'bear'),
    h1DataUrl: generateCandlestickChartSvg('Buy-side Liquidity Sweep', 'H1', 'EURUSD', 'bear'),
    m15DataUrl: generateCandlestickChartSvg('Bearish Order Block & FVG Entry', 'M15', 'EURUSD', 'bear'),
  },
  {
    id: 'btcusd_smc_buy',
    name: 'BTCUSD (Bitcoin) - SMC Liquidity Sweep & Demand Zone',
    symbol: 'BTC/USD',
    strategy: 'SMC',
    description: 'ตัวอย่าง Bitcoin เกิดการกวาด Sell-side Liquidity ใต้ Swing Low ก่อนมีแรง Displacement สร้าง FVG และย่อทดสอบ Demand Zone',
    h4DataUrl: generateCandlestickChartSvg('Macro Liquidity & Higher TF Bias', 'H4', 'BTCUSD', 'bull'),
    h1DataUrl: generateCandlestickChartSvg('Displacement & FVG Creation', 'H1', 'BTCUSD', 'bull'),
